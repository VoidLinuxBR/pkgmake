...
FN_GLOBAL_BOOL(himmelblaud_hello_enabled, himmelblaud_hello_enabled)
FN_GLOBAL_CONST_STRING(himmelblaud_hsm_pin_path, himmelblaud_hsm_pin_path)
FN_GLOBAL_BOOL(himmelblaud_sfa_fallback, himmelblaud_sfa_fallback)
