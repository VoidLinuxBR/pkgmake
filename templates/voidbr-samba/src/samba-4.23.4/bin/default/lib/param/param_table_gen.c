...
struct parm_struct parm_table[] = {
	...
	{
		.label		= "himmelblaud hello enabled",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(himmelblaud_hello_enabled),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "himmelblaud hsm pin path",
		.type		= P_STRING,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(himmelblaud_hsm_pin_path),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "himmelblaud sfa fallback",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(himmelblaud_sfa_fallback),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
