...
bool lpcfg_himmelblaud_hello_enabled(struct loadparm_context *);
const char *lpcfg_himmelblaud_hsm_pin_path(struct loadparm_context *);
bool lpcfg_himmelblaud_sfa_fallback(struct loadparm_context *);
